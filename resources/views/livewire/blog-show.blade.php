    ...
    <article class="py-16 lg:py-24">
        <div class="container mx-auto px-4 max-w-3xl">
            ...
            <p class="text-sm text-black font-mulish mb-8">
                ...
                {{-- Usando isoFormat para data completa com locale. Ex: "terça-feira, 19 de maio de 2025 17:52" --}}
                {{-- Verifique se o Carbon está configurado para pt_BR em AppServiceProvider --}}
            </p>
            ...
            {{-- Botão Voltar e Compartilhar (Sugestão) --}}
            <div class="mt-12 pt-8 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <div class="flex space-x-3">
                    ...
                    {{-- Link de Compartilhamento LinkedIn (Simples) --}}
                    ...
                    {{-- Adicione outros botões de compartilhamento (Twitter, Facebook) aqui se desejar --}}
                </div>
            </div>
        </div>
    </article>
