<section class="text-white py-20">
    <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-5 items-center px-10 lg:px-0 lg:gap-x-16">
            ...
            <div class="lg:col-span-3 w-full text-center lg:text-left" x-data="{ showModal: false }">
                ...
                <h1 class="uppercase font-poppins text-3xl sm:text-4xl font-bold text-white mb-2 text-center lg:text-left">
                    Pedro <span class="text-[#4169E1]">Sousa</span>
                </h1>

                <hr class="my-4 border-dashed border-gray-600  mx-auto lg:w-full lg:mx-0"> <div class="prose prose-lg lg:prose-xl prose-invert text-gray-300 font-mulish leading-relaxed max-w-none text-left ">
                    <p>
